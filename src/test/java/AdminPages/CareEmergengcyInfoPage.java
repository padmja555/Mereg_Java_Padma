...
public class CareEmergengcyInfoPage {
    WebDriver driver;
    ...
    public By physicianPhoneTypeDropdown = By.xpath("(//mat-select[@formcontrolname='phoneType'])[2]");
    public By physicianCountryCodeDropdown = By.xpath("(//mat-select[@formcontrolname='countryCode'])[2]");
    public By physicianPhoneNumber = By.xpath("(//div[contains(.,'Physician Information')]//input[@name='phoneNumber'])[2]");
    ...
    public By alternatePhoneNumber = By.xpath("(//input[@name='phoneNumber'])[2]");
    public By careFacilityName = By.xpath("//input[@formcontrolname='careFacilityName']");
    public By careFacilityPhoneTypeDropdown = By.xpath("//mat-select[@formcontrolname='careFacilityPhoneType']");
    ...
    public CareEmergengcyInfoPage(WebDriver driver) {
        this.driver = driver;
    }
