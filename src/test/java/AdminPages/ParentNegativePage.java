...
public class ParentNegativePage {
    WebDriver driver;
    ...
    By relationshipoptions = By.xpath("//div[@class='cdk-overlay-pane']//mat-option");
    ...
    By countrydropdown = By.xpath("//div[@class='cdk-overlay-pane']//mat-option");
    By statedropdown = By.xpath("(//mat-select[@name='state'])[1]");
    By statedropdownoptions = By.xpath("//div[@class='cdk-overlay-pane']//mat-option");
    ...
    By phonetypeoptions = By.xpath("//div[@class='cdk-overlay-pane']//mat-option");
    By Countrycode = By.xpath("(//mat-select[@formcontrolname='countryCode'])[1]");
    By Counrtycodeselect = By.xpath("//div[@class='cdk-overlay-pane']//mat-option");
    By phonenumber = By.xpath("(//input[@name='phoneNumber'])[1]");
    By Alternativephonenumbercode = By.xpath("(//mat-select[@name='alternateCountryCode'])[1]");
    By Alternativephonenumbercodeselect = By.xpath("//div[contains(@class,'cdk-overlay-pane')]//mat-option");
    By Alternativephonenumber = By.xpath("(//input[@name='phoneNumber'])[2]");
    By emailaddress = By.xpath("//input[@type='email' or @name='email' or contains(@id,'email') or @formcontrolname='email']");
    ...
    By AlternateGuardianRelationtypes = By.xpath("//div[@role='listbox']//mat-option");
    By AlternateGuardianPhoneType = By.xpath("//div[@id='mat-select-value-59']");
    By AlternateGuardiancountrycode = By.xpath("(//mat-select[@formcontrolname='countryCode'])[2]");
    By AlternateGuardiancountryCodeSelect = By.xpath("//div[@class='cdk-overlay-pane']//mat-option");
    ...
    public ParentNegativePage(WebDriver driver) {
        this.driver = driver;
    }
