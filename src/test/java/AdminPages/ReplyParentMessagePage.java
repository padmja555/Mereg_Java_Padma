...
public class ReplyParentMessagePage {

    WebDriver driver;
    WebDriverWait wait;
    Random random;

    public ReplyParentMessagePage(WebDriver driver) {
        this.driver = driver;
    ...
    public void clickOnParentTab() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        By staffTab = By.xpath("//div[@role='tab']//div[normalize-space()='Parent']");
