...
public class CheckDelateMessagePage {
    ...
    private By staffTab = By.xpath("//*[normalize-space()='Staff']");
    ...
    public CheckDelateMessagePage(WebDriver driver) {
        this.driver = driver;
    ...
    public void clickStaffTab() {
        try {
            ...
            WebElement staffTabElement = wait.until(ExpectedConditions.elementToBeClickable(staffTab));
