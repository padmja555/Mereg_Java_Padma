 ...
 */
public class IndidualChildRegistrationPage {

    private WebDriver driver;
    private WebDriverWait wait;

    // Locators for the registration page elements
    @FindBy(xpath = "//button[.//span[contains(text(), 'Complete Registration')]]")
    ...
    public IndidualChildRegistrationPage(WebDriver driver) {
        this.driver = driver;
