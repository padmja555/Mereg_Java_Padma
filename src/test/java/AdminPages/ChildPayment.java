...
public class ChildPayment {
    ...
    By ProccedpaymentButton= By.xpath("//mat-sidenav-content/app-subscriptioninfo/div[3]/button");
    	////mat-sidenav-content/app-complete-payment/div/h2	
    ////span[normalize-space()='Proceed to payment']/parent::button
    ...
    public ChildPayment(WebDriver driver, WebDriverWait wait) {
        this.driver = driver;
        this.wait = wait;
    }
