...
public class ParentDelateMessagePage {
    ...
    private By parentTab = By.xpath("//*[normalize-space()='Parent']");
    ...
    public ParentDelateMessagePage(WebDriver driver) {
        this.driver = driver;
    ...
    public void clickParentTab() {
        try {
            ...
            WebElement staffTabElement = wait.until(ExpectedConditions.elementToBeClickable(parentTab));
