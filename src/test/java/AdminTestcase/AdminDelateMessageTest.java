...
import AdminPages.AdminDelateMessagePage;
import Base.BaseDriver;
import org.testng.Assert;
import org.testng.annotations.BeforeMethod;
import org.testng.annotations.Test;

public class AdminDelateMessageTest extends BaseDriver {

	AdminDelateMessagePage checkadminDeletePage;
    ...
    public void setup() {
        try {
            ...
            checkadminDeletePage = new AdminDelateMessagePage(driver);
            checkadminDeletePage.clickOnMessageTab();
            checkadminDeletePage.clickAdminTab();
    ...
    public void testDeleteAllMessages() {
        try {
            ...
            checkadminDeletePage.openThreeDotsMenu();
            checkadminDeletePage.clickSelectChatOption();
            Thread.sleep(2000);
            
            // 2. Cancel any existing selections
            System.out.println("Step 2: Canceling checkboxes...");
            checkadminDeletePage.cancelAllCheckboxes();
            Thread.sleep(2000);
            
            // 3. Select ALL messages
            System.out.println("Step 3: Selecting all messages...");
            checkadminDeletePage.selectAllMessages();
            Thread.sleep(2000);
            
            // Verify selection
            int selectedCount = checkadminDeletePage.getSelectedMessageCount();
            ...
            checkadminDeletePage.deleteSelectedMessages();
            
            // 5. Take screenshot after deletion
            System.out.println("Step 5: Taking screenshot...");
            checkadminDeletePage.takeScreenshot("after_deletion");
    ...
    public void testSelectRandomMessageAndDelete() {
        try {
            ...
            // Debug page first
            checkadminDeletePage.debugPage();
            ...
            checkadminDeletePage.selectRandomMessage();
            Thread.sleep(2000);
            ...
            if (selectedCount == 0) {
                ...
                checkadminDeletePage.selectRandomMessage();
                Thread.sleep(2000);
                selectedCount = checkadminDeletePage.getSelectedMessageCount();
            ...
            checkadminDeletePage.takeScreenshot("before_deletion");
