...
import AdminPages.AllMessagePaginationPage;
import Base.BaseDriver;
import org.testng.annotations.BeforeMethod;
import org.testng.annotations.Test;

public class AllMessagePaginationTest extends BaseDriver {

	AllMessagePaginationPage messagesPage;
    ...
    public void setup() {
        ...
        messagesPage = new AllMessagePaginationPage(driver);
    ...
    */
    ...
    public void testPaginationRandomNavigation() {
    	...
    	AllMessagePaginationPage page = new AllMessagePaginationPage(driver);

        page.clickNextPage();
        page.clickPreviousPage();
        page.clickRandomPageNumber();

        System.out.println("✅ Pagination navigation successful");
    }
