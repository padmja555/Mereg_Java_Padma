...
public class SuperChildChoosePlanPage {
    ...
    By planToggles = By.xpath("//mat-button-toggle-group[@name='paymentPlan']//button");

 ////mat-button-toggle-group[@name='paymentPlan']//button
   ////mat-button-toggle-group[@name='paymentPlan']//mat-button-toggle
    
	public SuperChildChoosePlanPage(WebDriver driver) {
		this.driver = driver;
	}
	...
	*/
	public void ProceedToCompleteRegestration() {
		...
		By completeRegBtn = By.xpath("//span[normalize-space()='Complete registration']");

		// Ensure page is ready
		wait.until(ExpectedConditions.jsReturnsValue("return document.readyState=='complete'"));

		// Optional: wait for loader to disappear
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".spinner, .loading")));

		// Wait for visibility and clickability
		WebElement btn = wait.until(ExpectedConditions.elementToBeClickable(completeRegBtn));
		btn.click();
