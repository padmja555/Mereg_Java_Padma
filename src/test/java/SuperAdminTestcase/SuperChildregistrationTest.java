...
import SuperAdminPage.SuperChildregistrationPage;
import SuperAdminPage.SuperEnrollmentPage;
import SuperAdminPage.SuperLoginPage;

@Listeners(listeners.TestListener.class)
public class SuperChildregistrationTest extends BaseDriver {
    ...
    ;
        ...
        //} catch (Exception e) {
            ...
            SuperChildregistrationPage registrationPage = new SuperChildregistrationPage(driver);
