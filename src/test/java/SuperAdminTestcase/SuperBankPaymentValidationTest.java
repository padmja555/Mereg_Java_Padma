...
import SuperAdminPage.SuperBankPaymentValidationPage;
...
public class SuperBankPaymentValidationTest extends BaseDriver {
    Paymentpage paymentPage;
    ChildPayment childpayment1;
    ...
    public void usBankAccountPaymentFlowTest() {
        try {
           ...
           // paymentpage.selectAnyGuardianWithChildren();
            Thread.sleep(3000);
            //paymentpage.selectPaymentOption("full");
            // Step 5: Select Child
           // payment.selectFirstChildrens();
            ...
            Thread.sleep(1000);
            // Step 9: Proceed
            //paymentpage.proceedToPayment();        // 3. Verify Payment Summary and click Pay Securely button          
            ...
            SuperBankPaymentValidationPage bankPaymentPage = new SuperBankPaymentValidationPage(driver, wait);
            //bankPaymentPage = new SuperBankPaymentValidationPage(driver, wait);
